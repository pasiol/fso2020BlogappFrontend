...
const LoginForm = ({ user, username, setUsername, password, setPassword, handleLogin, handleLogout }) => {
  ...
  if (user === null ) {
    ...
    return (
      <div>
        <h2>Blogs</h2>
          <p>{user} has logged in.<LogoutButton user={user} handleLogout={handleLogout}/></p>
      </div>
    )
  }
}
